...
import { SequenceOverviewState, stateSelector } from './sequence-overview.reducer';
import { Sequence } from './sequence-overview.model';
import { environment } from '../../../../environments/environment';

@Injectable()

export class SequenceOverviewService {
  private state$: Observable<SequenceOverviewState>;

  constructor(
    public Http: HttpClient,
    private store: Store<SequenceOverviewState>) {
